...
# ggmap(p3)+
p3+geom_polygon(data=mycoorddata,aes(x=Longitude,y=Latitude),alpha=0.2,
                colour="red",fill="red")+
  geom_path(data=mycoorddata,aes(x=Longitude,y=Latitude),colour="white",alpha=0.4,size=2)+
