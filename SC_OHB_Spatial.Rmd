...
```{r echo=FALSE, message=FALSE, warning=FALSE}
kable(ref_dfRM_sex, format = "pandoc", caption = 'Table 3 | Directional means of home range after being adjusted for year, sex and sample size.')
```
...
kable(YR_GRP_Means.KDE, format = "pandoc", caption = 'Table 4 | Raw Group 95% KDE home range means male and female home ranges at Stone Canyon.')
```
...
kable(YR_GRP_Means.KDE, format = "pandoc", caption = 'Table 5 | Raw Group 50% KDE home range means male and female home ranges at Stone Canyon.')
```
