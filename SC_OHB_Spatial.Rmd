...
```
Figure __ | Total relocations of 22 Gila Monsters throughout Stone Canyon for the entire study period.
...
kable(YR_GRP_Means.KDE, format = "pandoc", caption = 'Table  | Raw Group 95% KDE home range means male and female home ranges at Stone Canyon.')
```
...
```{r echo=FALSE, message=FALSE, warning=FALSE}
YR_GRP_Means.KDE <- summarySE(sub, measurevar="Home_Range_50kde",
                            groupvars=c("Sex"),na.rm = TRUE)

kable(YR_GRP_Means.KDE, format = "pandoc", caption = 'Table  | Raw Group 50% KDE home range means male and female home ranges at Stone Canyon.')
```
...
kable(OL_Table, format = "pandoc", caption = 'Table 8 | Home range overlap of Gila Monsters at the nutrient subsidized site. Male-male overlaps only occured between two pairs of males: M14-M69 and M119-M215 at 0.5 ha. and 19.5 ha. respectively and were therefore not included in the table..')
```
...
# SEAS_GRP_Means
kable(hr.overlap.anal, format = "pandoc", caption = 'Table 10 | Summary of home range overlap.')
```
